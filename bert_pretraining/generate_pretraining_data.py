...
def main():
    ...
    parser.add_argument('--train_corpus', type=Path,
                        default='./organized_data.txt')
    ...
    parser.add_argument("--epochs_to_generate", type=int, default=4,
    ...
    tokenizer = Tokenizer(f'../pretrained/{sp_model_name}.model')
